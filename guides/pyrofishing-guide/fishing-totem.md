...
It is easy to obtain a Fishing Totem. You need to build a multiblock structure and provide a set amount of items. (The items required are consistent across **all** servers).What items do I need?
